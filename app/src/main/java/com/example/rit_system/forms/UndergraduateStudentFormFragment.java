 ...
 * Use the {@link UndergraduateStudentFormFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class UndergraduateStudentFormFragment extends Fragment {

    public static final String TAG = "UndergraduateStudentForm";
    ...
    public UndergraduateStudentFormFragment() {
     ...
     * @return A new instance of fragment UndergraduateStudentFormFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static UndergraduateStudentFormFragment newInstance(UndergraduateStudent student) {
        UndergraduateStudentFormFragment fragment = new UndergraduateStudentFormFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_undergraduate_student_forms, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (student != null) {
            ...
            ((TextInputEditText) view.findViewById(R.id.InputProjectName)).setText(student.getProjectName());
            ((TextInputEditText) view.findViewById(R.id.InputOrientationType)).setText(student.getTypeOfOrientation());
        ...
        view.findViewById(R.id.AddButton).setOnClickListener(v -> {
            ...
            if (isNew) student = new UndergraduateStudent();
            ...
            student.setProjectName(Objects.requireNonNull(((TextInputEditText) view.findViewById(R.id.InputProjectName)).getText()).toString());
            student.setTypeOfOrientation(Objects.requireNonNull(((TextInputEditText) view.findViewById(R.id.InputOrientationType)).getText()).toString());
            student.setStatus(Objects.requireNonNull(((TextInputEditText) view.findViewById(R.id.InputStatus)).getText()).toString());

            UndergraduateStudentDAO graduateStudentDAO = new UndergraduateStudentDAO(getContext());
            if(isNew) graduateStudentDAO.addUndergraduateStudent(student);
            else graduateStudentDAO.updateUndergraduateStudent(student.getId(), student);
